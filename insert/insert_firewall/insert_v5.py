...
# アセンブリファイルのパス
input_file_path = 'u_firewall.s'
output_file_path = 'v5-all/u_firewall.s'
...
memory_access_instructions_multi = ['movw', 'movzwl', 'movl', 'movq', 'movdqu', 'movdqa', 'movups', 'punpcklwd', 'movaps']
