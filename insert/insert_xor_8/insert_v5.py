...
# アセンブリファイルのパス
input_file_path = 'u_xor_vpn.s'
output_file_path = 'v5-all/u_xor_vpn.s'
# output_file_path = 'tmp.s'
...
memory_access_instructions_multi = ['movw', 'movzwl', 'movl', 'movq', 'movdqu', 'movdqa', 'movups', 'punpcklwd', 'movaps', 'xorq']
                    ...
                    if label:
                        ...
                        if match:
                            ...
                            if inside_parentheses == "%rsp":
                                ...
                                jmp_offset = 9 + 4
                    # 新しい命令を構築
                    new_instruction1 = f"\tleaq\t{high_addr}, %rbx"
                    new_instruction2 = f"\tjg\t\t.+{jmp_offset}\n\tleaq\t{low_addr}, %rbx"
