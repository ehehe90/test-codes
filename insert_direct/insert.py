...
# アセンブリファイルのパス
input_file_path = 'u_firewall/all/u_firewall_portion.s'
# output_file_path = 'u_openssl_vpn/v6-all/u_openssl_vpn.s'
output_file_path = 'u_firewall/all/u_firewall.s'
        ...
        for start, end in insert_range_list:
            if start <= i <= end:
                if memory_access_pattern_single.search(line):
                    ...
                    insert = f"\tleaq\t{low_addr}, %rbx" + instructions_to_insert_multi1
